...
```{}
Mapping("BRD-K37798499")   
CellMorphologyEnrichmentAnalysis(10)  #10 is the number of first top cell morphological features.
crossTabulation(10, "BRD-K37798499")  #10 is the number of first top cell morphological features, and "BRD-K37798499" is a query.
```
...
```{}
Mapping("BRD-K37798499")
RankCellMorphologicalFeatures(20) #20 is the number of first top cell morphological features, ranked based on SCS  
```
You can find the results in your current directory.
