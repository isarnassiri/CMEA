...
#"BRD-K37798499" is name of a drug/small compound molecule. 
```
...
Definition of parameters:
#20 is the number of first top cell morphological features 
#"BRD-K37798499" is name of a drug/small compound molecule.
```
...
Definition of parameters:
#10 is the number of first top cell morphological features. 
#0.1 is the proportion of cell morphological features which are associated with an indicated gene set (Support). 
#0.6 is an indication of how often the rule has been found to be true (confidence).
#"BRD-K37798499" is name of a drug/small compound molecule.
```
You can find the results in your current directory.
